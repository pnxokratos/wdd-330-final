const inventors = [
  ...
  const birthdayDate = inventors.sort((a, b) => a.year > b.year ? 1 : -1);
  console.table(birthdayDate);
  ...
  const listDe = links.map(links => links.textContent).filter(streetName => streetName.includes('de'));
  console.log(listDe);
